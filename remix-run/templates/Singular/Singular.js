                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap justify-center">
                    {post?.categories?.nodes?.map((category, i) => (
                      <a href={category.uri} className="mr-3 text-sm font-medium uppercase text-sky-500 dark:text-sky-300 hover:text-primary-600 dark:hover:text-sky-400">
                        {category.name}
                      </a>
                    ))}
                  </div>
                  ...
                  <dl>
                    <div className="sm:flex sm:flex-wrap justify-center xl:block">
                      ...
                      <dd className="text-center items-center">
                        <a href={post?.author?.node?.uri} className="text-sky-500 dark:text-sky-300 dark:hover:text-sky-400 hover:text-sky-600 dark:text-sky-400 pt-5 text-center">
