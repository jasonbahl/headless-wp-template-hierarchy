...
export const generatedSchema = {
  ...
  subscription: {},
  [SchemaUnionsKey]: {
    ContentNode: ["ActionMonitorAction", "MediaItem", "Page", "Post"],
    DatabaseIdentifier: [
      "ActionMonitorAction",
      "Category",
      "Comment",
    ...
    NodeWithTemplate: ["ActionMonitorAction", "MediaItem", "Page", "Post"],
    NodeWithTitle: ["ActionMonitorAction", "MediaItem", "Page", "Post"],
    UniformResourceIdentifiable: [
      "ActionMonitorAction",
      "Category",
      "ContentType",
...
export interface ContentNode {
  __typename?: "ActionMonitorAction" | "MediaItem" | "Page" | "Post";
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * Connection between the ContentNode type and the ContentType type
   */
